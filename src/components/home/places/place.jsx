...
import car from '../../../../public/assets/bg blue.png'
...
const styles=[{name:'' ,style:'w-[15px] h-[15px] absolute left-[20%] z-20 bg-white rounded-2xl'},
  {style:'w-[15px] h-[15px] absolute left-[40%] z-20 bg-white rounded-2xl'},
  {style:'w-[15px] h-[15px] absolute left-[60%]  z-20 bg-white rounded-2xl'},
  {style:'w-[15px] h-[15px] absolute left-[80%] z-20 bg-white rounded-2xl'}
]
 ...
 <div className='  w-full md:pt-24 pt-20  overflow-hidden bg-white text-black h-[100vh]'  ref={sectionref}>
      <div className='flex flex-col items-center justify-center gap-[100px]  w-full lg:mt-[20px] mt-[50px] ' >
        ...
        <div className="relative w-full h-10 flex items-center">
          ...
          <hr className="border-t border-zinc-600 w-full absolute" />
          {styles.map((elem, index) => (
            ...
            >
              <div className="w-[15px] h-[15px] bg-zinc-600 rounded-full"></div>
    ...
    <div ref={movingRef} className='md:!w-[127px] !w-[62px] !h-[40px] md:!h-[72px] absolute left-[20%] rotate-180 z-30'><Image src={car} height={200} width={400} objectFit='cover'  className='transition-transform duration-700  h-[100%] w-[100%] ease-in-out'/>
    </div>
          </div> 
          </div>
